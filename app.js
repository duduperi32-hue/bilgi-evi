...
const VOCATIONAL = {
  ...
  bilisim:  { label:'Bilişim Teknolojileri',     kulturDersleri:['Matematik','Fizik','Kimya','Türk Dili','İngilizce','Tarih','Coğrafya','Din Kültürü'], meslekDersleri:['Bilişim Teknolojilerinin Temelleri','Bilgisayarlı Tasarım Uygulamaları','Programlama Temelleri','Mesleki Gelişim Atölyesi','Ağ Sistemleri','Veritabanı'] },
